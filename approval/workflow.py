...
so an approval cannot be reused for a different action.
"""
...
def create_approval_request(*, actor: str, role: str, environment: str,
                            tool_name: str, arguments: dict[str, Any]) -> ApprovalRequest:
...
def review_approval(request_id: str, *, reviewer: str, approve: bool) -> ApprovalRequest:
...
def consume_approval(request_id: str, *, actor: str, role: str, environment: str,
                     tool_name: str, arguments: dict[str, Any]) -> tuple[bool, str]:
